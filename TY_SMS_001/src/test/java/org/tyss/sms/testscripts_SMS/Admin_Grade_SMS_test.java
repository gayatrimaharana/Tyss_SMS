...
import org.tyss.sms.pageRepository.SmsAdminGrade;
import org.tyss.sms.pageRepository.SmsLoginPage;

public class Admin_Grade_SMS_test {
	...
	public static void main(String[] args) {
		...
		homePage.getGradeTab();
		SmsAdminGrade smsAdminGrade=new SmsAdminGrade(driver);
		smsAdminGrade.addGrade(smsWebDriverUtility, smsExcelUtility, smsJavaUtility, "Admin_Grade");

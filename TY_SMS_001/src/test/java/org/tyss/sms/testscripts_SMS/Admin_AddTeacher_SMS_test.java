...
public class Admin_AddTeacher_SMS_test {
	...
	public static void main(String[] args) {
		...
		homePage.getAddTeacherTab();
		SmsAdminAddTeacher smsAdminAddTeacher=new SmsAdminAddTeacher(driver);
		smsAdminAddTeacher.addTeacher(smsWebDriverUtility, smsExcelUtility, smsJavaUtility, "Admin_Teacher_AddTeacher");
		smsExcelUtility.SaveDataInExcel(IConnect.SMSEXCELFILEPATH);
		smsExcelUtility.closeExcel();

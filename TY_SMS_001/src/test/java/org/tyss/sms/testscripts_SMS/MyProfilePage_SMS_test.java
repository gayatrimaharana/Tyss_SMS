...
import org.tyss.sms.pageRepository.SmsAdminMyProfile;
import org.tyss.sms.pageRepository.SmsLoginPage;

public class MyProfilePage_SMS_test {
	...
	public static void main(String[] args) {
		...
		homePage.getMyProfileTab();
		SmsAdminMyProfile smsAdminMyProfile=new SmsAdminMyProfile(driver);
		smsAdminMyProfile.adminMyProfileUpdate(smsWebDriverUtility, smsExcelUtility, "Admin_MyProfile");
